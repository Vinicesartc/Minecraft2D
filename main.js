...
function myKeyDown(e)
{
    ...
    {
        console.log("p e shift pressionadas juntos");
    ...
    {
        console.log("m e shift pressionadas juntos");
        blockImageWidth = blockImageWidth - 10;
        blockImageHeight = blockImageHeight - 10;
        document.getElementById("currentWidth").innerHTML=blockImageWidth;
        document.getElementById("currentHeight").innerHTML=blockImageHeight;
...
function left()
{
    if(playerX>=0)
    {
        ...
        console.log("quando a tecla direcional para a esquerda for pressionada, X = "+ playerX + " , Y = "+playerY);
        canvas.remove(playerObject);
        playerUpdate();
    }
}
...
function right()
{
    if(playerX<=850)
    {
        playerX = playerX + blockImageWidth;
        console.log("altura da imagem do bloco = "+ blockImageWidth);
        console.log("quando a tecla direcional para a direita for pressionada, X = "+ playerX + " , Y = "+playerY);
        canvas.remove(playerObject);
        playerUpdate();
    }
}